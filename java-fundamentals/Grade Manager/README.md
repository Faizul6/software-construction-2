...
In this exercise, I implemented a simple Grade Management System in Java.



The program stores student grades, calculates basic statistics, and determines letter grades based on numerical scores.

This task focuses on working with arrays, loops, conditional statements, and data processing.
...
The program simulates a simple grade management system.
...
The program assumes that user input is always valid (numbers between 0 and 100).
