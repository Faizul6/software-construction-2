...
In this exercise, I implemented a simple calculator in Java using methods.



The goal was to practice method creation, parameter passing, return values, and program organization.  

Each arithmetic operation is implemented in a separate method.
...
The calculator supports multiple calculations in one session.
...
The program assumes that user input is valid.
