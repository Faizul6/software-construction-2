...
In this exercise, I implemented a Word Counter program in Java.



The program analyzes a sentence or paragraph entered by the user and calculates various statistics about the text.  

This task focuses on string manipulation, character analysis, and data processing.
